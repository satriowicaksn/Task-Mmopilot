  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header bg-dark text-white">
        <span class="fa fa-cart-plus"></span>&nbsp&nbsp Data Order
      </div>
      <div class="card-body">
        ...
        <a href="<?= base_url();  ?>index.php/order/halaman_add" class="btn btn-sm btn-danger col-6 mb-2" style="border-radius: 20px;"><span class="fa fa-plus"></span>&nbsp&nbsp Add New Order </a>
        <a href="<?= base_url();  ?>index.php/order/history" class="btn btn-sm btn-primary col-6 mb-5" style="border-radius: 20px;"><span class="fa fa-eye"></span>&nbsp&nbsp Histori Order (Order selesai)</a>
