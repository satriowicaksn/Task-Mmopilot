...
<section>
  <div class="card ml-3">
    ...
    <div class="card-body">
      ...
      <form class="" action="<?= base_url() ?>index.php/user/add_client" method="post">
        ...
        <div class="row ml-1 mb-3">
          ...
          <div class="input-group col-md-6">
            ...
            <input type="text" class="form-control" name="discord" value="">
          </div>
          <!-- <a href="#" class="btn btn-sm btn-light text-info mt-2 ml-3" id="add_item"> <span class="fa fa-plus"></span>&nbsp&nbsp Tambah Item Utama</a> -->
        </div>
        <div class="row ml-1 mb-3">
          <div class="form-group">
            <label for="" class="ml-3 text-dark">Alamat</label>
              <textarea class="form-control ml-3" name="address" rows="8" cols="100"></textarea>
          </div>
        </div>
        <br>
